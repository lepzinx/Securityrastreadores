...
<head>
    <meta charset="utf-8">
    <title>SecurityRastreadores - Cadastro de Equipamentos</title>
...
<li class="active"><a href="">Cadastro de jornadas </a></li>
				...
				<div class="panel-heading">
					<h2>Jornadas</h2>
                                        <div class="panel-ctrls">
                                           <i class='separator'></i>
                                            <a href="<?=base_url()?>index.php/dashboard/novajornada" class="btn  panel-ctrls-center">NOVO</a>
                                            <i class='separator'></i>
                                        </div>
				</div>
