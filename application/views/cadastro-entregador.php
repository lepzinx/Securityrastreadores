...
<li class="active"><a href="">Cadastro de entregadores </a></li>
				...
				<div class="panel-heading">
					<h2>Entregadores</h2>
                                        <div class="panel-ctrls">
                                           <i class='separator'></i>
                                            <a href="<?=base_url()?>index.php/dashboard/novoentregador" class="btn  panel-ctrls-center">NOVO</a>
                                            <i class='separator'></i>
                                        </div>
				</div>
							...
							<tr>
								...
								<th>Modelo</th>
                                                ...
                                                <tbody>
                                                     ...
                                                     foreach($entregador_adm as $ent){?>
                                                    <tr style="cursor: pointer;" onmouseover="this.style.backgroundColor='#efefef'" onmouseout="this.style.backgroundColor=''" onclick='window.location.href = "<?=base_url()?>index.php/dashboard/editarentregador/<?=$ent->entrega_id?>";'>
                                                        <td><?=$ent->entrega_nome;?></td>
                                                        <td><?=$ent->entrega_cpf;?></td>
                                                        <td><?=$ent->entrega_endereco;?></td>
                                                        <td><?=$ent->entrega_fixo;?></td>
                                                        <td><?=$ent->entrega_cel;?></td>
                                                        <td><?=$ent->entrega_marca;?></td>
                                                        <td><?=$ent->entrega_modelo;?></td>
                                                        <td><?=$ent->entrega_cor;?></td>
                                                        <td><?=$ent->entrega_ano;?></td>
                                                        <td><?=$ent->entrega_placa;?></td>
                                                        <td><?=$ent->entrega_cnh;?></td>
                                                        <td><?=$ent->entrega_validade;?></td>
    <?php if($this->session->userdata["usuario_tipo"] == "A"){?>
                                                              <td><?=$ent->cliente_id;?></td> 
                                                                <?php }?>
                                                    </tr>
                                                     <?php }
                                                      }?>
