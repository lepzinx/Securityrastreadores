...
<head>
    <meta charset="utf-8">
    <title>SecurityRastreadores - Relatorio de Umidade</title>
...
<li class="active"><a href="">Relatório de Umidades</a></li>
			...
			<div class="panel-body no-padding">
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						<thead>
							<tr>
								<th>Equipamento</th>
                                                                <th>Umidade MAXIMA</th>
								<th>Umidade MINIMA</th>
                                                                <th>Ultima Umidade</th>
								<th>Umidade média</th>
								
							</tr>
						</thead>
                                                <tbody>
                                                    <?php foreach($Equip as $eqp) {?>
                                                           <tr style="cursor: pointer;" onmouseover="this.style.backgroundColor='#efefef'" onmouseout="this.style.backgroundColor=''" onclick='window.location.href = "<?=base_url()?>index.php/dashboard/detalhestemperatura/<?=$eqp->equip_id?>";'>
                                                        <td><?=$eqp->equip_id?> </td>
                                                        <?php if($eqp->equip_umid_al_max_ativa == 0){?>
                                                            <td>Desativado</td>
                                                        <?php }else{?> 
                                                            <td><?=$eqp->equip_umid_al_max?></td>
                                                        <?php } ?>
                                                        <?php if($eqp->equip_umid_al_min_ativa == 0){?>
                                                            <td>Desativado</td>
                                                        <?php }else{?> 
                                                            <td><?=$eqp->equip_umid_al_min?></td>
                                                        <?php } ?>
                                                        <?php $ultimos_dados = $this->geral_model->pegarUltimosDados($eqp->equip_id); 
                                                             foreach($ultimos_dados as $ultimo){  
                                                        ?>
                                                             <td><?=$ultimo->umid_dados;?>ºC</td>
                                                             <?php }?>
                                                             <td><?=$this->geral_model->umidadeMedia($eqp->equip_id)?></td>
