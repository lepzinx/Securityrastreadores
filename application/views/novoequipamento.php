...
<li class="active"><a href="<?= base_url()?>index.php/dashboard/cadastroequipamento">Cadastro Equipamento</a></li>
<li class="active"><a href="">Novo equipamento</a></li>
				...
				<div class="panel-body">
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
                                                    <form method="post" action="<?= base_url()?>index.php/dashboard/cadastrarequipamento" class="form-horizontal">
                                                           
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Id do equipamento</label>
									<div class="col-sm-8">
										<input name="id" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
										<p class="help-block">Numero de identificação do equipamento</p>
									</div>
								</div>
                                                            		<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Descrição</label>
									<div class="col-sm-8">
										<input name="descricao" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
										<p class="help-block">Descrição do equipamento</p>
									</div>
								</div>
                                                           <div class="form-group">
									<label for="checkbox" class="col-sm-2 control-label">Habilitar : </label>
									<div class="col-sm-8">
										<div class="checkbox checkbox-inline">
											<label><input name="temp" type="checkbox"> Temperatura</label>
										</div>
										<div class="checkbox checkbox-inline">
											<label><input name="umid" type="checkbox"> Umidade</label>
										</div>

									</div>
								</div>
								<div class="form-group">
									<label for="selector1" class="col-sm-2 control-label">Usuario</label>
									<div class="col-sm-8"><select name="selector1" id="selector1" class="form-control">
										...
										<option value="<?= $usu->cliente_id?>"><?= $usu->cliente_id?> - <?= $usu->cliente_nome?></option>
                                                                         ...
                                                                         <input type="submit" class="btn btn-raised btn-success" value="Cadastrar equipamento">
                                                                          <a class="btn btn-raised" href="<?=base_url()?>index.php/dashboard/cadastroequipamento/">Voltar</a>
                                                                        </div>
