				...
				<div class="panel-heading">
					<h2>Grupo</h2>
                                        <div class="panel-ctrls">
                                           <i class='separator'></i>
                                            <a href="<?=base_url()?>index.php/dashboard/novogrupo" class="btn  panel-ctrls-center">NOVO</a>
                                            <i class='separator'></i>
                                        </div>
				</div>
							...
							<tr>
								...
								<th>Temperatura MINIMA</th>
                                                ...
                                                <tbody>
                                                     ...
                                                     <?php foreach($grupos_adm as $gpr){?>
                                                    <tr style="cursor: pointer;" onmouseover="this.style.backgroundColor='#efefef'" onmouseout="this.style.backgroundColor=''" onclick='window.location.href = "<?=base_url()?>index.php/dashboard/editargrupo/<?=$gpr->grupo_id?>";'>
                                                        <td><?=$gpr->grupo_nome;?></td>
                                                        <td><?=$gpr->grupo_tempmax;?></td>
                                                        <td><?=$gpr->grupo_tempmin;?></td>

                                                    </tr>
                                                     <?php } ?>
                                                        <?php foreach($grupos_usu as $gpr){?>
