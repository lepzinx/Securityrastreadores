                    ...
                    <div class="static-content">
                        <div class="page-content">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><a href="">Novo grupo</a></li>
                                            ...
                                            <div class="panel-body">
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="horizontal-form">
                                                        <form method="post" action="<?= base_url()?>index.php/dashboard/cadastrargrupo" class="form-horizontal">

                                   
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Nome do grupo</label>
									<div class="col-sm-8">
										<input name="grupo_nome" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="grupo_tempmax" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="grupo_tempmin" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
...
<script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.9.2/jquery-ui.min.js"></script> -->
						...
						<script src="<?= base_url() ?>assets/demo/demo-tiles.js"></script>       
