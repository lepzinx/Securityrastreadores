					...
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="nome" type="text" class="form-control" id="focusedinput" value="<?=$cli->cliente_id?>">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="cpf" type="text" class="form-control" id="focusedinput" value="<?=$cli->cliente_cpf?>">
									</div>
									<div class="col-sm-2">
