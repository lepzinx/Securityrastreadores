				...
				<div class="panel-heading">
					<h2>Clientes</h2>
                                        <div class="panel-ctrls">
                                           <i class='separator'></i>
                                            <a href="<?=base_url()?>index.php/dashboard/cadastrarcliente" class="btn  panel-ctrls-center">NOVO</a>
                                            <i class='separator'></i>
                                        </div>
				</div>
				<div class="panel-body no-padding">
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
                                                      ...
                                                      <tr style="cursor: pointer;" onmouseover="this.style.backgroundColor='#efefef'" onmouseout="this.style.backgroundColor=''" onclick='window.location.href = "<?=base_url()?>index.php/dashboard/editarcliente/<?=$cli->cliente_id?>";'>
                                                        <td><?=$cli->cliente_nome;?></td>
                                                        <td class="center"><?= $this->geral_model->pegarEquipsClientes($cli->cliente_id);?></td>
                                                            <td><?= $this->geral_model->pegarEquipsWIFI($cli->cliente_id);?></td>
                                                            <td><?= $this->geral_model->pegarEquipsGPRS($cli->cliente_id);?></td>
