...
<li class="active"><a href="">Cadastro de equipamentos  </a></li>
				...
				<div class="panel-heading">
					<h2>Equipamentos</h2>
                                        <div class="panel-ctrls">
                                           <i class='separator'></i>
                                            <a href="<?=base_url()?>index.php/dashboard/novoequipamento" class="btn  panel-ctrls-center">NOVO</a>
                                            <i class='separator'></i>
                                        </div>
				</div>
			<div class="panel-body no-padding">
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
                                                    ...
                                                    <tr style="cursor: pointer;" onmouseover="this.style.backgroundColor='#efefef'" onmouseout="this.style.backgroundColor=''" onclick='window.location.href = "<?=base_url()?>index.php/dashboard/detalhes/<?=$eqp->equip_id?>";'>
                                                        <td><?=$eqp->equip_cor;?> <?=$eqp->equip_desc;?></td>
                                                        <td><?=$eqp->equip_id;?></td>
                                                        <td><?=$this->geral_model->pegarDataHoraEquip($eqp->equip_id);?></td>
