...
<li class="active"><a href="">Novo usuario Usuario</a></li>
				...
				<div class="panel-body">
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
                                                    <form method="post" action="<?= base_url()?>index.php/dashboard/cadastrarcli" class="form-horizontal">
                                                           
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Nome</label>
									<div class="col-sm-8">
										<input name="nome" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="cpf" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="email" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="senha" type="password" class="form-control" id="focusedinput" >
									</div>
									<div class="col-sm-2">
										<p class="help-block">Senha de acesso</p>
									</div>
								</div>      
                                                            <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Telefone Fixo</label>
									<div class="col-sm-8">
										<input name="fixo" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="celular" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="endereco" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="bairro" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="cidade" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
									...
									<div class="col-sm-8">
										<input name="uf" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="cep" type="text" class="form-control" id="focusedinput" value="">
                                                                                 <input type="submit" class="btn btn-raised btn-success" value="Cadastrar">
