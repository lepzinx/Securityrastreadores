...
<li class="active"><a href="">Novo entregador</a></li>
				...
				<div class="panel-body">
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
                                                    <form method="post" action="<?= base_url()?>index.php/dashboard/cadastrarentregador" class="form-horizontal" enctype="multipart/form-data">
                                                           
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Nome</label>
									<div class="col-sm-8">
										<input name="entrega_nome" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="entrega_cpf" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="entrega_fixo" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="entrega_cel" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="entrega_endereco" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="entrega_marca" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="entrega_modelo" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
									...
									<div class="col-sm-8">
										<input name="entrega_cor" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
									...
									<div class="col-sm-8">
										<input name="entrega_ano" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
									...
									<div class="col-sm-8">
										<input name="entrega_placa" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
									...
									<div class="col-sm-8">
										<input name="entrega_cnh" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
									...
									<div class="col-sm-8">
										<input name="entrega_validade" type="text" class="form-control" id="focusedinput" value="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
									...
									<div class="col-sm-8"><select name="cliente_id" id="selector1" class="form-control">
										...
										<option value="<?= $usu->cliente_id?>"><?= $usu->cliente_id?> - <?= $usu->cliente_nome?></option>
                                                      ...
                                                      <div class="form-group">
					<label class="col-sm-2 control-label" for="addon3">Foto</label>
					<input type="file" name="foto" id="inputFile4">
					<div class="col-sm-8 input-group">
						<input type="text"  readonly="" id="addon3"  class="form-control" placeholder="">
