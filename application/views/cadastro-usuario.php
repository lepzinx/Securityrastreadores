...
<li class="active"><a href="">Cadastro Cliente</a></li>
				...
				<div class="panel-heading">
					<h2>Clientes</h2>
                                        <div class="panel-ctrls">
                                           <i class='separator'></i>
                                            <a href="<?=base_url()?>index.php/dashboard/cadastrarusuario" class="btn  panel-ctrls-center">NOVO</a>
                                            <i class='separator'></i>
                                        </div>
				</div>
				<div class="panel-body no-padding">
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
                                                      ...
                                                      <tr style="cursor: pointer;" onmouseover="this.style.backgroundColor='#efefef'" onmouseout="this.style.backgroundColor=''" onclick='window.location.href = "<?=base_url()?>index.php/dashboard/editarusuario/<?=$cli->usuario_cod?>";'>
                                                        <td><?=$cli->usuario_nome;?></td>
                                                        <td><?=$cli->usuario_cpf;?></td>
                                                        <td><?=$cli->usuario_email;?></td>
                                                        <td><?=$cli->usuario_celular;?></td>
                                                        <td><?=$cli->usuario_fixo;?></td>
                                                        <?php if($cli->usuario_tipo == "C"){?>
                                                        <td>Cliente Administrador</td>
                                                        <?php } else if($cli->usuario_tipo == "A"){ ?>
                                                        <td>Administrador</td>
                                                        <?php }else if($cli->usuario_tipo == "M"){ ?>
                                                        <td>Monitor</td>
                                                        <?php }else if($cli->usuario_tipo == "D"){ ?>
                                                        <td>Cliente normal</td>
                                                        <?php }?>
                                                          <?php if($cli->usuario_tipo == "C"){?>
                                                        <td><?=$cli->cliente_id?> - <?=$this->geral_model->pegarNomeCliente($cli->cliente_id)?> </td>
                                                        <?php } else if($cli->usuario_tipo == "A"){ ?>
                                                        <td>Administrador</td>
                                                        <?php }else if($cli->usuario_tipo == "M"){ ?>
                                                        <td>Monitor</td>
