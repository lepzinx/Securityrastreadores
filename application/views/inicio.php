...
<head>
	<meta charset="utf-8">
	<title>SecurityRastreadores -  Pagina inicial</title>
		...
		<ul class="nav navbar-nav toolbar pull-right">
			...
			<li class="dropdown toolbar-icon-bg hidden-xs">
				<a href="#" class="hasnotifications dropdown-toggle" data-toggle='dropdown'>
					<span class="icon-bg"><i class="material-icons">mail</i></span><span class="badge badge-info"></span>
				</a>
				<div class="dropdown-menu animated notifications">
					<div class="topnav-dropdown-header">
		...
		<div id="layout-static">
			<div class="static-sidebar-wrapper sidebar-blue">
				<div class="static-sidebar">
					<div class="sidebar">
						...
						<div class="widget stay-on-collapse" id="widget-sidebar"><?php if($this->session->userdata['usuario_tipo'] == "A") { ?>
							<nav role="navigation" class="widget-body">
								<ul class="acc-menu">
									<li class="nav-separator"><span>Navegação</span></li>
									<li>
										<a class="withripple" href="<?= base_url();?>">
											<span class="icon">
												<i class="material-icons">home</i>
											</span><span>Inicio</span><span class="badge badge-teal">2</span>
										</a>
									</li>
									...
									<li>
										<a class="withripple" href="javascript:;"><span class="icon"><i class="material-icons">flash_on</i></span><span>Cadastros</span></a>
										<ul class="acc-menu">
									...
									<li>
										<a class="withripple" href="javascript:;"><span class="icon"><i class="material-icons">settings</i></span><span>Relatórios</span></a>
										<ul class="acc-menu">
									...
									<li>
										<a class="withripple" href="<?= base_url();?>">
											<span class="icon">
												<i class="material-icons">home</i>
											</span><span>Monitoramento</span>
										</a>
									</li>
									<li>
										<a class="withripple" href="<?= base_url(); ?>index.php/usuarios/sair"><span class="icon"><i class="material-icons">map</i></span><span>Sair</span></a>
									</li>

								</ul>
							</nav><?php } ?><?php if($this->session->userdata['usuario_tipo'] == "C") { ?>
							<nav role="navigation" class="widget-body">
								<ul class="acc-menu">
									<li class="nav-separator"><span>Navegação</span></li>
									<li>
							...
							</nav><?php } ?><?php if($this->session->userdata['usuario_tipo'] == "M") { ?>
							<nav role="navigation" class="widget-body">
								<ul class="acc-menu">
									<li class="nav-separator"><span>Navegação</span></li>
									<li>
							...
							</nav><?php } ?><?php if($this->session->userdata['usuario_tipo'] == "D") { ?>
							<nav role="navigation" class="widget-body">
								<ul class="acc-menu">
									<li class="nav-separator"><span>Navegação</span></li>
									<li>
			...
			<div class="static-content-wrapper">
				<div class="static-content">
								...
								<div class="row">
									<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
										<div class="info-tile info-tile-alt tile-purple">
											...
											<div class="stats">
												<div class="tile-content"><span class="material-icons tile-icon">face</span></div>
											</div>
										</div>
									</div>
									<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
										<div class="info-tile info-tile-alt tile-brown ">
											...
											<div class="stats">
												<div class="tile-content"><span class="material-icons tile-icon">account_box</span></div>
											</div>
										</div>
									</div>
									<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
										<div class="info-tile info-tile-alt tile-gray ">
											...
											<div class="stats">
												<div class="tile-content">
													<span class="material-icons tile-icon">directions_walk</span>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
										<div class="info-tile info-tile-alt tile-indigo">
											...
											<div class="stats">
												<div class="tile-content"><span class="material-icons tile-icon">devices</span></div>
											</div>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
										<div class="info-tile info-tile-alt tile-success clearfix">
											<div class="info">
												...
												<div class="tile-body "><span><?=$qtdOnline?></span></div>
											</div>
											<div class="stats">
												<div class="tile-content"><span class="material-icons tile-icon">signal_wifi_4_bar</span></div>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
										<div class="info-tile info-tile-alt tile-danger">
											<div class="info">
												...
												<div class="tile-body "><span><?=$qtdOffline?></span></div>
											</div>
											<div class="stats">
												<div class="tile-content"><span class="material-icons tile-icon">signal_wifi_off</span></div>
											</div>
										</div>
									</div>
									<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
										<div class="info-tile info-tile-alt tile-primary">
											...
											<div class="stats">
												<div class="tile-content"><span class="material-icons tile-icon">location_searching</span></div>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
										<div class="info-tile info-tile-alt tile-orange">
											...
											<div class="stats">
												<div class="tile-content"><span class="material-icons tile-icon">dvr</span></div>
											</div>
										</div>
									</div>
													...
													<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
														<thead>
															<tr>
																...
																<th class="center">Equipamentos</th>
																<th class="center">WIFI</th>
																<th class="center">GPRS</th>
																<th class="center">Monitorados 24hs</th>
														...
														<tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="center"><?=$this->geral_model->pegarEquipsClientes($cli->cliente_id)?></td>
																<td class="center"><?=$this->geral_model->pegarEquipsWIFI($cli->cliente_id)?></td>
																<td class="center"><?=$this->geral_model->pegarEquipsGPRS($cli->cliente_id)?></td>
																<td class="center"><?=$this->geral_model->pegarEquipsClientes24($cli->cliente_id)?></td>
																<td class="center"><?php if($cli->cliente_status == 1){
                                                                              echo "<span class='label label-success'>Ativado</span>";
                                                                  }else{
                                                                      echo "<span class='label label-danger'>Desativado</span>";
                                                                                         }?></td>
                                                                <td class="center"><a id="local" href="#" data-toggle="modal" data-target="#confirmationModal"><i class="material-icons">location_on</i></a></td>
                    ...
                    <?php } ?>
                       <?php if($this->session->userdata['usuario_tipo'] == "C" || $this->session->userdata['usuario_tipo'] == "D" ){ ?>
								<div class="page-heading">
									<h1>Inicio</h1>
