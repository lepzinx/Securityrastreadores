...
<head>
    <meta charset="utf-8">
    <title>SecurityRastreadores - Relatorio de temperatura</title>
...
<div data-widget-group="group1">
    ...
    <div class="page-heading">            
                               <h1>Relatorio das temperaturas</h1>
								...
								<th>Temperatura média</th>
                                                ...
                                                <tbody>
                                                    <?php foreach($Equip as $eqp) {?>
                                                        ...
                                                        <td><?=$eqp->equip_id?> </td>
                                                        <?php if($eqp->equip_temp_al_max_ativa == 0){?>
                                                            <td>Desativado</td>
                                                        <?php }else{?> 
                                                            <td><?=$eqp->equip_temp_al_max?></td>
                                                        <?php } ?>
                                                        <?php if($eqp->equip_temp_al_min_ativa == 0){?>
                                                            <td>Desativado</td>
                                                        <?php }else{?> 
                                                            <td><?=$eqp->equip_temp_al_min?></td>
                                                        <?php } ?>
                                                        ...
                                                        ?>
                                                             ...
                                                             <?php }?>
                                                             <td><?=$this->geral_model->temperaturaMedia($eqp->equip_id)?></td>
