...
<head>
    <meta charset="utf-8">
    <title>SecurityRastreadores - Relatorio de Jornada</title>
...
<li class="active"><a href="">Relatório de Jornada</a></li>
							...
							<tr>
								...
								<th>Iniciador</th>
                                                ...
                                                <tbody>
                                                     ...
                                                     foreach($jornadas_adm as $jor){?>
                                                    <tr style="cursor: pointer;" onmouseover="this.style.backgroundColor='#efefef'" onmouseout="this.style.backgroundColor=''" onclick='window.location.href = "<?=base_url()?>index.php/dashboard/configurarjornada/<?=$jor->jornada_id?>";'>
                                                        <td><?=$jor->equip_id;?></td>
                                                        <td><?=$jor->entrega_id;?></td>
                                                        <td><?=$jor->jornada_inicio;?></td>
                                                        <?php if($jor->jornada_fim == "0000-00-00 00:00:00"){?>
                                                             <td> Em andamento</td>
                                                        <?php } else {?>
                                                             <td> <?=$jor->jornada_fim?></td>
                                                         <?php }?>
                                                           <?php $usuario = $this->geral_model->infoCliente($jor->usuario_codi);
                                                               foreach($usuario as $usu){ ?>
                                                                   <td> <?=$jor->usuario_codi?> - <?=$usu->usuario_nome?></td>
                                                           <?php    } ?>
                                                          <?php if($jor->usuario_codf == 0){?>
                                                             <td> Não finalizada</td>
                                                        <?php } else {?>
                                                               <?php $usuario = $this->geral_model->infoCliente($jor->usuario_codf);
                                                               foreach($usuario as $usu){ ?>
                                                                   <td> <?=$jor->usuario_codf?> - <?=$usu->usuario_nome?></td>
                                                           <?php    } ?>
                                                         <?php }?>
	  ...
	  return [
	    {
	      ...
	      key: 'Trocar', //key  - the name of the series.
