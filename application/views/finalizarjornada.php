...
<li><a  class="withripple" href="<?= base_url();?>"><span class="icon">
                    ...
                    <div class="static-content">
                        <div class="page-content">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><a href="<?= base_url() ?>index.php/dashboard/cadastrojornada">Cadastro de jornadas</a></li>
                                <li class="active"><a href="">Editar ou finalizar jornada</a></li>
                                            ...
                                            <div class="panel-body">
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="horizontal-form">
                                                        <form method="post" action="<?= base_url()?>index.php/dashboard/editarjornada/<?=$indice?>" class="form-horizontal">

                                                            <div class="form-group">
                                                                <label for="equip_id" class="col-sm-2 control-label">Equipamentos</label>
                                                                <div class="col-sm-8"><select name="equip_id" id="equip_id" class="form-control">
                                                                        <?php foreach ($equipamentos as $eqp) { ?>
                                                                            <option value="<?=$eqp->equip_id;?>"><?=$eqp->equip_id;?></option>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="entrega_id" class="col-sm-2 control-label">Entregador</label>
                                                                    <div class="col-sm-8"><select name="entrega_id" id="entrega_id" class="form-control">
                                                                            
                                                                                <option value="0">0</option>

                                                                        </select>
                                                                        <input type="submit" class="btn btn-raised btn-success" value="Editar">
                                                                        <a class="btn btn-raised" href="<?= base_url() ?>index.php/dashboard/cadastrojornadas/">Voltar</a>
                                                                        <a class="btn btn-raised btn-danger pull-right" href="javascript:;" onclick="ConfirmaExclusao()">Finalizar</a>
                                                                    </div>
  ...
  location="<?=base_url()?>index.php/dashboard/finalizarjornada/<?=$indice?>";
  }
}</script>
