                    ...
                    <div class="static-content">
                        <div class="page-content">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><a href="">Nova jornada</a></li>
                                            ...
                                            <div class="panel-body">
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="horizontal-form">
                                                        <form method="post" action="<?= base_url()?>index.php/dashboard/cadastrarjornadas" class="form-horizontal">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-8"><select name="entrega_id" id="entrega_id" class="form-control">
                                                                        ...
                                                                        <input type="submit" class="btn btn-raised btn-success" value="Cadastrar jornada">
