...
<li><a  class="withripple" href="<?= base_url();?>"><span class="icon">
                    ...
                    <div class="static-content">
                        <div class="page-content">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><a href="<?= base_url() ?>index.php/dashboard/cadastrogrupo">Cadastro de grupo</a></li>
                                <li class="active"><a href="">Editar grupos</a></li>
                                ...
                                <div data-widget-group="group1">
                                            ...
                                            <div class="panel-body">
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="horizontal-form">
                                                        <form method="post" action="<?= base_url()?>index.php/dashboard/alterargrupo/<?=$indice?>" class="form-horizontal">
                                                                <?php foreach($grupo as $gpr){ ?>
                                                           	<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Nome do grupo</label>
									<div class="col-sm-8">
										<input name="grupo_nome" type="text" class="form-control" id="focusedinput" value="<?=$gpr->grupo_nome?>">
									</div>
									<div class="col-sm-2">
										<p class="help-block">Nome do grupo</p>
									</div>
								</div>
                                                            		<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Temperatura maxima</label>
									<div class="col-sm-8">
										<input name="grupo_tempmax" type="text" class="form-control" id="focusedinput" value="<?=$gpr->grupo_tempmax?>">
									</div>
									<div class="col-sm-2">
										<p class="help-block">Temperatura maxima</p>
									</div>
								</div>
                                                            	<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Temperatura minima</label>
									<div class="col-sm-8">
										<input name="grupo_tempmin" type="text" class="form-control" id="focusedinput" value="<?=$gpr->grupo_tempmin?>">
									</div>
									<div class="col-sm-2">
										<p class="help-block">Temperatura minima</p>
									</div>
								</div>
								   ...
								   <?php if($this->session->userdata["usuario_tipo"] == "A"){ ?>
									...
									<div class="col-sm-8">
                                                                                ...
                                                                                <a class="btn btn-raised" href="<?= base_url() ?>index.php/dashboard/cadastrargrupo/">Voltar</a>
  ...
  if( confirm( 'Tem certeza que deseja finalizar esta jornada?' ) ) {
  location="<?=base_url()?>index.php/dashboard/excluirgrupo/<?=$indice?>";
  }
}</script>
