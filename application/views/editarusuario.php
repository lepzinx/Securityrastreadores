...
<li class="active"><a href="<?= base_url()?>index.php/dashboard/cadastrousuario">Cadastro Usuario</a></li>
...
<div data-widget-group="group1">
 ...
 <?php if($indice==null){?>
     <div class="alert alert-danger">
         <p>Você não entrou em nenhum cliente válido</p>
</div>
 <?php}else if($this->geral_model->verificaCliente($indice) == false{?>
         <div class="alert alert-danger">
         <p>Você não entrou em nenhum cliente válido</p>
</div>
 ...
 <?php }else{ ?>       
        <div class="col-sm-2"></div>
				...
				<div class="panel-heading">
					<h2>Editar ou excluir usuario</h2>
	
				</div>
				<div class="panel-body">
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
                                                    <form method="post" action="<?= base_url()?>index.php/dashboard/editarCli/<?=$indice?>" class="form-horizontal">
                                                            <?php foreach($cliente as $cli){ ?>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Nome</label>
									<div class="col-sm-8">
										<input name="nome" type="text" class="form-control" id="focusedinput" value="<?=$cli->usuario_nome?>">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8"><select name="tipo" id="selector1" class="form-control">
                                                                                <?php if($this->session->userdata["usuario_tipo"] == "A"){
                                                                                ?>
                                                                                <option value="A">Administrador </option>
                                                                                <option value="M">Monitor</option>
                                                                                <option value="C">Cliente Administrador </option>
                                                                                  <option value="D">Cliente secundário</option>
                                                                                <?php }else{ ?>
                                                                                    <option value="C">Cliente Administrador </option>
                                                                                  <option value="D">Cliente secundário</option>
                                                                                <?php } ?>
									...
									<div class="col-sm-8"><select name="cliente" id="selector1" class="form-control">
									...
									<div class="col-sm-8">
										<input name="cpf" type="text" class="form-control" id="focusedinput" value="<?=$cli->usuario_cpf?>">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="email" type="text" class="form-control" id="focusedinput" value="<?=$cli->usuario_email?>">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="fixo" type="text" class="form-control" id="focusedinput" value="<?=$cli->usuario_fixo?>">
									</div>
									<div class="col-sm-2">
										<p class="help-block">Telefone do usuario</p>
									</div>
								</div>
                                                              <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Telefone celular</label>
									<div class="col-sm-8">
										<input name="celular" type="text" class="form-control" id="focusedinput" value="<?=$cli->usuario_celular?>">
									</div>
									<div class="col-sm-2">
										<p class="help-block">Telefone móvel do usuario</p>
									</div>
								</div>
                                                                <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Endereço</label>
									<div class="col-sm-8">
										<input name="endereco" type="text" class="form-control" id="focusedinput" value="<?=$cli->usuario_endereco?>">
									</div>
									<div class="col-sm-2">
										<p class="help-block">Endereço do usuario</p>
									</div>
								</div>
                                                                <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Bairro</label>
									<div class="col-sm-8">
										<input name="bairro" type="text" class="form-control" id="focusedinput" value="<?=$cli->usuario_bairro?>">
									</div>
									<div class="col-sm-2">
									...
									<div class="col-sm-8">
										<input name="cidade" type="text" class="form-control" id="focusedinput" value="<?=$cli->usuario_cidade?>">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
									...
									<div class="col-sm-8">
										<input name="uf" type="text" class="form-control" id="focusedinput" value="<?=$cli->usuario_uf?>">
									</div>
									<div class="col-sm-2">
										<p class="help-block">SC, RJ, SP</p>
									</div>
								</div>
                                                                <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">CEP</label>
									<div class="col-sm-8">
										<input name="cep" type="text" class="form-control" id="focusedinput" value="<?=$cli->usuario_cep?>">
                                                                                 <input type="submit" class="btn btn-raised btn-primary" value="editar">
                                                                   <a class="btn btn-raised" href="<?=base_url()?>index.php/dashboard/cadastrocliente/">Voltar</a>
  ...
  location="<?=base_url()?>index.php/dashboard/excluirentregador/<?=$indice?>";
  }
}</script>
